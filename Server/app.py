...
os.environ["REPLICATE_API_TOKEN"] = "r8_UZfH63D3hdJeqTDTc3DMuqtJE6CiJ7B3XE5zw"
...
def query():
    ...
    query_text= query_text+ " As my ayurvedic doctor, suggest me herbal remedies and solutions to get relief."
    if not query_text:
